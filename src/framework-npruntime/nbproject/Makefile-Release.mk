...
${OBJECTDIR}/plugin.o: plugin.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -DENABLE_BINRELOC -DXPCOM_GLUE -DMOZILLA_STRICT_API -DXP_UNIX -DMOZ_X11 -Igecko-sdk/include -I/root/pwlib/include -o ${OBJECTDIR}/plugin.o plugin.cpp
...
${OBJECTDIR}/npp_gate.o: npp_gate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -DENABLE_BINRELOC -DXPCOM_GLUE -DMOZILLA_STRICT_API -DXP_UNIX -DMOZ_X11 -Igecko-sdk/include -I/root/pwlib/include -o ${OBJECTDIR}/npp_gate.o npp_gate.cpp

${OBJECTDIR}/npn_gate.o: npn_gate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -O2 -DENABLE_BINRELOC -DXPCOM_GLUE -DMOZILLA_STRICT_API -DXP_UNIX -DMOZ_X11 -Igecko-sdk/include -I/root/pwlib/include -o ${OBJECTDIR}/npn_gate.o npn_gate.cpp
