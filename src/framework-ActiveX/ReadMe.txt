========================================================================
    ACTIVEX CONTROL DLL : Js2n Project Overview
========================================================================

ControlWizard has created this project for your Js2n ActiveX Control
...
that make up your Js2n ActiveX Control DLL.
...
Js2n.ico
    ...
    is included by the main resource file Js2n.rc.

/////////////////////////////////////////////////////////////////////////////
CJs2nCtrl control:

Js2nCtrl.h
    This file contains the declaration of the CJs2nCtrl C++ class.

Js2nCtrl.cpp
    This file contains the implementation of the CJs2nCtrl C++ class.

Js2nPropPage.h
    This file contains the declaration of the CJs2nPropPage C++ class.

Js2nPropPage.cpp
    This file contains the implementation of the CJs2nPropPage C++ class.

CJs2nCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CJs2nCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file Js2n.rc.
...
stdafx.h, stdafx.cpp
    ...
    named Js2n.pch and a precompiled types (PCT) file named stdafx.obj.
